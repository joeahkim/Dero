...
class ClientController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'client_id_card_front' => 'required|image|max:20480',
            'client_id_card_back' => 'required|image|max:20480',
            ...
            'guarantor_id_card_front' => 'required|image|max:20480',
            'guarantor_id_card_back' => 'required|image|max:20480',
    ...
    {
        // Fetch all clients with their guarantors and next of kin
        $clients = Client::with(['guarantor', 'nextOfKin'])->get();

        return view('auth.super-admin.allclients', compact('clients'));
    }
}
